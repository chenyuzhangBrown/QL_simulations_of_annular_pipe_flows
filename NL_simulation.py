...
# Restart
write, last_dt = IVP.load_state('/glade/scratch/chenyuz/checkpoints85_13_nl/checkpoints85_13_nl_s1.h5', -1)
...
snapshots1 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret85_nl/ret85_14_nl_g',sim_dt = 1,max_writes=100)
...
snapshots2 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret85_nl/ret85_14_nl_c',sim_dt = 1,max_writes=100)
...
# analysis
check = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/checkpoints85_14_nl', sim_dt=1, max_writes=100, mode = fh_mode)
