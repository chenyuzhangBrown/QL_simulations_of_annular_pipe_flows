...
#If not pathlib.Path('/glade/scratch/chenyuz/checkpoints81_17/checkpoints81_17_s1.h5').exists():
...
#else#:
    # Restart
write, last_dt = IVP.load_state('/glade/scratch/chenyuz/ret81/checkpoints81_23/checkpoints81_23_s1.h5', -1)
...
snapshots1 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret81/ret81_24_g',sim_dt = 0.5 ,max_writes=120)
...
snapshots2 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret81/ret81_24_c',sim_dt = 0.5 ,max_writes=120)
...
check = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret81/checkpoints81_24', sim_dt = 1 , max_writes=120, mode = fh_mode)
