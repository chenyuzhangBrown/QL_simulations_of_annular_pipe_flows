...
#if not pathlib.Path('/glade/scratch/chenyuz/checkpoints79_18/checkpoints79_18_s1.h5').exists():
...
#else:
    # Restart
write, last_dt = IVP.load_state('/glade/scratch/chenyuz/ret79/checkpoints79_24/checkpoints79_24_s1.h5', -1)
...
snapshots1 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret79/ret79_25_g',sim_dt = 0.5 ,max_writes=120)
...
snapshots2 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret79/ret79_25_c',sim_dt = 0.5 ,max_writes=120)
...
check = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret79/checkpoints79_25', sim_dt = 0.5 , max_writes=120, mode = fh_mode)
