...
#else:
    # Restart
write, last_dt = IVP.load_state('/glade/scratch/chenyuz/checkpoints70_6/checkpoints70_6_s1.h5', -1)
...
snapshots1 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret70_7_g',sim_dt = 1 ,max_writes=100)
...
snapshots2 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret70_7_c',sim_dt = 1 ,max_writes=100)
...
check = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/checkpoints70_7', sim_dt = 2, max_writes=100, mode = fh_mode)
