...
domain = de.Domain([z_basis, th_basis, r_basis], grid_dtype=np.float64,mesh=[16,16])
...
#if not pathlib.Path('/users/czhang54/scratch/checkpoints78_3/checkpoints78_3_s1.h5').exists():
#
#
...
#
#    # try to load initial value from a file
#    #hf = h5py.File('/users/czhang54/scratch//state_variables7_g','r')
#    
#    #ul['g'] = hf.get('tasks/ul')
#    #uh['g'] = hf.get('tasks/uh')
#    #vl['g'] = hf.get('tasks/vl')
#    #vh['g'] = hf.get('tasks/vh')
#    #wl['g'] = hf.get('tasks/wl')
#    #wh['g'] = hf.get('tasks/wh')
#
#
#    #vl['g'] = -vl['g']
#    #vh['g'] = -vh['g']
...
#else:
    # Restart
write, last_dt = IVP.load_state('/glade/scratch/chenyuz/checkpoints75_18/checkpoints75_18_s1.h5', -1)
...
snapshots1 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret75_19_g',sim_dt = 0.5 ,max_writes=100)
   # save full state variable in grid space ('g') for u
snapshots1.add_task(IVP.state['ul'],layout='g',name='ul')
snapshots1.add_task(IVP.state['vl'],layout='g',name='vl')
snapshots1.add_task(IVP.state['wl'],layout='g',name='wl')
snapshots1.add_task(IVP.state['pl'],layout='g',name='pl')


snapshots1.add_task(IVP.state['uh'],layout='g',name='uh')
snapshots1.add_task(IVP.state['vh'],layout='g',name='vh')
snapshots1.add_task(IVP.state['wh'],layout='g',name='wh')
snapshots1.add_task(IVP.state['ph'],layout='g',name='ph')


snapshots2 = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/ret75_19_c',sim_dt = 0.5 ,max_writes=100)
...
check = IVP.evaluator.add_file_handler('/glade/scratch/chenyuz/checkpoints75_19', sim_dt = 1, max_writes=100, mode = fh_mode)
